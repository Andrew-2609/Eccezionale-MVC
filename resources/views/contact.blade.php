...
@section('content')
    <div class="container pt-3">
        ...
        <div class="texto-contato">
            ...
            <div class="row">
                <div class="descricao-contato col-lg-5">
                    <p>O Eccezionale MVC está aberto durante 24h para responder sua mensagem o quanto antes, em sua maior clareza!</p>
                </div>
            </div>
        </div>
        ...
        <div class="pb-5">
            ...
            @if(Auth::check())
                {!! Form::text('name', Auth::user()->name, array('placeholder' => '','class' => 'form-control transparent-input', 'style' => 'display: none'))!!}
                {!! Form::text('email', Auth::user()->email, array('placeholder' => '','class' => 'form-control transparent-input', 'style' => 'display: none'))!!}
            ...
            @else
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                        <div class="form-group">
                            <strong>Nome:</strong>
                            {!! Form::text('name', null, array('placeholder' => '','class' => 'form-control transparent-input', 'required'))
                            !!}
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-12 col-md-12 col-lg-4">
                        <div class="form-group">
                            <strong>Email:</strong>
                            {!! Form::text('email', null, array('placeholder' => '','class' => 'form-control transparent-input', 'required'))
                            !!}
