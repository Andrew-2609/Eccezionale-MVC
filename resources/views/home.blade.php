            ...
            <div class="row text-white">
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <div class="box-part-1 text-center">
                        ...
                        <div class="text">
                            <span>Nossa prioridade é a sua satisfação, a nossa reputação, e aos menores preços!</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <div class="box-part-2 text-center">
                        ...
                        <div class="text">
                            <span>Temos serviços de entrega das 5h às 23h, além de reservas com as mesas de sua
                                escolha!</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <div class="box-part-3 text-center">
                        ...
                        <div class="text">
                            <span>Contamos com as melhores comidas dos três melhores mercados da Europa, comprove à
                                vontade!</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <div class="box-part-4 text-center">
                        ...
                        <div class="text">
                            <span>O Eccezionale MVC já é o maior e melhor restaurante de sua categoria em toda a
                                América!</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="journal-info">
                        <a href="https://github.com/Andrew-2609"><img src="{{ asset('img/chef2.jpg') }}" class="img-responsive"
                                alt="img"></a>
